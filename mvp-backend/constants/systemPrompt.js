// System prompt moved from src/constants/systemPrompt.js (frontend ES module)
// to the backend so it is never exposed to the browser.
const SYSTEM_PROMPT = `Você é o assistente financeiro virtual do Maurício Fidelis, educador financeiro.
